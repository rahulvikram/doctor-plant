      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <SignedIn>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-[#D8EFD9] overflow-hidden">
                ...
                <h2 className="text-xl font-semibold text-[#2E7D32]">Plant Health Assistant</h2>
                <p className="text-[#558B59] mt-1">
                    Chat with our AI assistant to get help with plant identification, disease diagnosis, and care tips.
                </p>
                </div>
                <div className="p-0">
                <ChatInterface />
